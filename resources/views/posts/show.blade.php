                    ...
                    <script>
                        ...
                        */
                        (function() { // DON'T EDIT BELOW THIS LINE
                            ...
                            s.src = 'https://easy-blog-filament.disqus.com/embed.js';
    ...
    <aside aria-label="Related articles" class="py-8 lg:py-24 bg-gray-50 dark:bg-gray-800">
        <div class="px-4 mx-auto max-w-screen-xl">
            ...
            <div class="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
                @forelse ($related_posts as $post)
                    <article class="max-w-xs">
                        <a href="{{ route('posts.show', $post->slug) }}">
                            <object data="{{ $post->banner_url }}" class="rounded-lg w-full object-cover mb-5">
                        ...
                        <p class="mb-4 font-light text-gray-500 dark:text-gray-400 line-clamp-2">{{ $post->excerpt }}
                        </p>
                        <a href="{{ route('posts.show', $post->slug) }}"
                ...
                @empty
                    <h1 class="text-lg font-semibold-text-gray-500 italic">
                        Related posts is current not available
                    </h1>
                @endforelse
            </div>
        </div>
