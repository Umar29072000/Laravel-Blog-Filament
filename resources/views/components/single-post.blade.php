<div>
    <div class="relative">
        <img class="object-cover object-center w-full h-64 rounded-lg lg:h-80" src="{{ $post->banner_url }}"
            alt="{{ $post->title }}">
    ...
    <span class="px-2 py-1 rounded-full bg-blue-600/20 text-blue-500 text-sm mb-2">{{ $post->category->name }}</span>
